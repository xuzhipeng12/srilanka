...
func JWTAuth() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if token == "" {
			...
			tools.Error(c, tools.ErrorCode, errors.New(errmsg), errmsg)
			c.Abort()
			return
		}
		...
		if err != nil {
			...
			tools.Error(c, tools.ErrorCode, err, "错误:"+err.Error())
			c.Abort()
			return
		}
